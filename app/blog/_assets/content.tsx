...
// Helper function to find a category by slug (throws if not found)
const getCategoryBySlug = (slug: string): categoryType => {
...
// Helper function to find an author by slug (throws if not found)
const getAuthorBySlug = (slug: string): authorType => {
...
export const articles: articleType[] = [
  {
    ...
    categories: [
      getCategoryBySlug(categorySlugs.feature),
    ],
    // The author of the article. It's used to generate a link to the author's bio page.
    author: getAuthorBySlug(authorSlugs.marc),
